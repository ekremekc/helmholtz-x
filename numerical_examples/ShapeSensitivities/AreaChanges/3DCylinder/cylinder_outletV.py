...
edge_facets = edge_tags.find(outlet_tag)
...
span = 2
outlet_element_tag = 3
ts_dolfinx = [gmsh.model.getParametrization(1,outlet_element_tag, point) for point in edge_coordinates]
...
xdmf_writer("Functions/V_outlet",mesh,V_func)
