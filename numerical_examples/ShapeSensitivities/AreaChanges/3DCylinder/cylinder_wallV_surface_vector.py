...
gmsh.option.setNumber('Mesh.MeshSizeMin', 0.02) # 0.05 working
...
node_tags, coords, t_coords = gmsh.model.mesh.getNodes(2,lateral_tag, includeBoundary=False)
norm = gmsh.model.getNormal(wall_element_tag,t_coords)
...
# TODO Fix span_u=0 and span_u=8, because they share the same displacement field, but only have half 
span_u = 2
...
xdmf_writer("Functions/V_wall_surface_vector",mesh,V_func)
