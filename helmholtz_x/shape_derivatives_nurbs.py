...
def degenerate_shape_derivative_neumann(gmsh_model, mesh, facet_tags, p_dir_1, p_dir_2, p_adj_norm_1, p_adj_norm_2, c,
...
def degenerate_shape_derivative_neumann_nonaxisymmetric(gmsh_model, mesh, facet_tags, p_dir_1, p_dir_2, p_adj_norm_1, p_adj_norm_2, c,
                                        surface_elementary_tag, surface_physical_tag,
    ...
    for span_v in range(1,N_cpt_v-1): # We do not compute the derivatives of the first and the last cpt on the surface
        ...
        for span_u in range(0,8):
            ...
            eig_sort_ind = np.argsort(np.abs(eig))
            print(eig_sort_ind)
            derivatives[span_v][span_u] = eig[eig_sort_ind[1]]
